...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Crearea grupei de parametri</li>
        </ol>
    </nav>
    <div class="title-block">
        <h3 class="title"> Crearea grupei de parametri </h3>
...
<div class="list-content">
    <form class="form-reg" method="POST" action="{{ route('properties-groups.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="part col-md-12">
                <ul>
                    <li>
                        ...
                        <input type="text" name="name_{{ $lang->lang }}" data-lang="{{ $lang->lang }}">
                    </li>
                </ul>
            </div>
        </div>
