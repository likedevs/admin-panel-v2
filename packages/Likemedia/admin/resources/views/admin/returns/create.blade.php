    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        ...
        <select class="form-control" name="status_return">
            <option value="new">{{trans('front.cabinet.historyOrder.new')}}</option>
            <option value="processing">{{trans('front.cabinet.historyOrder.processing')}}</option>
            <option value="cancelled">{{trans('front.cabinet.historyOrder.cancelled')}}</option>
            <option value="completed">{{trans('front.cabinet.historyOrder.completed')}}</option>
        </select>
      </div>
    </div>
