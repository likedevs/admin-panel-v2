<div class="row {{ count($productsList) < 3 ? 'justify-content-start' : 'justify-content-center' }} templateProductsTwo">
    @foreach ($productsList as $key => $product)
    @if ($key == 1)
    <div class="col-md-6 col-sm-12 product4">
    ...
    @endif
    @if ($key == 2)
    <div class="col-md-6 col-sm-12 product5">
        <div class="searchItem">
            @if ($product->created_at < date('Y-m-d', strtotime('+20 days')))
                <div class="reduceBloc">
                    New
    ...
    @endif
    @if ($key == 3)
    <div class="col-lg-4 col-md-5 col-sm-12 product6">
        <div class="response-subproduct">
        <div class="searchItem">
          <div class="searchImg">
